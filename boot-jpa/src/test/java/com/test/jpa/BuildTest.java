...
public class BuildTest {
	...
	void test() {
		...
		//	- 생성자 다양하게 오버로딩 > 개발자 비용 발생(퇴근이 늦어짐 ㅜㅅㅜ)
		...
		//빌더 패턴 사용
		//User 클래스 > 객체 생성 
		//Builder라는 중첩 클래스 기본객체를 불러옴 
		//new User.Builder()에를 불러와서 기본객체를 만들고 .setSeq(51L)라는 애를 돌려받고 .setName("꿀꿀이")라는 빌더를 또 돌려받음
		User u1 = new User.Builder()
						...
						.build()
						; 
		System.out.println(u1); //User [seq=51, name=꿀꿀이, age=5, address=서울시, gender=m]
		
		//1. 초기화를 하고 싶지 않은 멤버를 처리가능
		User u2 = new User.Builder()
						.setName("꿀꿀이")
						.setGender("m")
						.build()
						;
		System.out.println(u2); //User [seq=null, name=꿀꿀이, age=null, address=null, gender=m]
		...
		User u3 = new User.Builder()
						...
						.build()
						;
		System.out.println(u3); //User [seq=51, name=꿀꿀이, age=null, address=null, gender=m]
